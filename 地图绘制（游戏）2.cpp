...
void myInit(void)
{
     ...
     fileaa=fopen(".\\map2.mmp","rb+");
     if(fileaa)
       fclose(fileaa);
     else{
       fileaa=fopen(".\\map2.mmp","wb+");
       fclose(fileaa);
     }
}
void myDisplay(void)
{
    ...
    fclose(fileee);
        ...
        glBegin(GL_LINE_LOOP);
           glVertex2i(1720-aspect*aspectlong,70);
           glVertex2i(1720-aspect*aspectlong,50);
           glVertex2i(1770-aspect*aspectlong,50);
           glVertex2i(1770-aspect*aspectlong,70);
        glEnd();
          glColor3f(1.0,0,0);
        glBegin(GL_LINE_LOOP);
           glVertex2i(20-aspect*aspectlong,470);
           glVertex2i(20-aspect*aspectlong,450);
           glVertex2i(70-aspect*aspectlong,450);
           glVertex2i(70-aspect*aspectlong,470);
        glEnd();    
    glFlush();
}
void myIdle(void)
